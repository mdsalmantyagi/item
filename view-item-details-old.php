                  ...
                  <div class="cover">
                    ...
                    <div class="cover-body d-flex justify-content-between align-items-center">
                      <div>
                        ...
                        <span class="profile-name"><!-- Item's title, Item's Brand Name --><?=$dataitem['item_title'];?>, <?=$dataitem['ibm_title'];?></span>
                                        <p>
                                        ...
                                        <p class="profile-name">
                                            ...
                                            <span class="lead-assignee-title"><?=$dataitem['itm_title'];?><!-- Item Type Name --></span>
                                        </p>
                      </div>
                    ...
                    <div class="card-body">
                                           ...
                                           <form action="../lib/item.php" method="POST">
                                              <div class="card card-body address_card">
                                                  <div class="row">
                                                    <div class="form-group col-md-12">
                                                        <textarea type="text" name="description" value="Unknown" class="form-control" rows="7" placeholder="Enter Department"><?=$dataitem['item_description'];?></textarea>
                                                     </div> 
                                                  </div>
